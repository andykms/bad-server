...
import { getCustomerValidation, validatePatchCustomer } from '../middlewares/validations'
...
customerRouter.patch('/:id', validatePatchCustomer, auth, roleGuardMiddleware(Role.Admin), updateCustomer)
